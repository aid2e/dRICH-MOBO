...
echo "shell_wrapper_job_fake genMomentumScan_job_fake"
# echo $EPIC_MOBO_UTILS/genMomentumScan_job_local.sh $1 $2 $3 $4 $7 $6
# $EPIC_MOBO_UTILS/genMomentumScan_job_local.sh $1 $2 $3 $4 $7 $6

echo $AIDE_HOME/ProjectUtils/ePICUtils/genMomentumScan_job_local_fake.sh $1 $2 $3 $4 $7 $6
$AIDE_HOME/ProjectUtils/ePICUtils/genMomentumScan_job_local_fake.sh $1 $2 $3 $4 $7 $6
