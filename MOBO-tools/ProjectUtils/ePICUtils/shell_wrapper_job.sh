...
$EPIC_MOBO_UTILS/dRICHAna recon_scan_$6_kaon+_p_$1_eta_$2_$3.root recon_scan_$6_kaon+_p_$1_eta_$2_$3.txt $5
$EPIC_MOBO_UTILS/genMomentumScan_job.sh $1 $2 $3 $4 "pi+" $6
$EPIC_MOBO_UTILS/dRICHAna recon_scan_$6_pi+_p_$1_eta_$2_$3.root recon_scan_$6_pi+_p_$1_eta_$2_$3.txt $5
EOF
